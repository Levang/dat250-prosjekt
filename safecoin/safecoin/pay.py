...
def payPage():
    ...
    if form_validate.is_submitted() and form_validate.email_payment.data and form_validate.password_payment.data:
        ...
        flash(
            f"Successfully transferred {form_validate.kr.data},{form_validate.ore.data if form_validate.ore.data else '00'},- from account {form.tfrom.data} to {form.to.data}!",
            "success")
